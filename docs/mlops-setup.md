...
git add README.md docs .gitignore oh_nytaxi_mlops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[oh_nytaxi_mlops/databricks.yml](../oh_nytaxi_mlops/databricks.yml) file.
...
Follow the instructions in [oh_nytaxi_mlops/resources/README.md](../oh_nytaxi_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../oh_nytaxi_mlops/resources/README.md)  to propose, test, and deploy
