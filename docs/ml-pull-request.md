...
Opening a pull request will trigger a[workflow](../.github/workflows/oh_nytaxi_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/oh_nytaxi_mlops/oh_nytaxi_mlops-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/oh_nytaxi_mlops/oh_nytaxi_mlops-model)
. 
