...
# ``oh_nytaxi_mlops/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-oh_nytaxi_mlops-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.oh_nytaxi_mlops.oh_nytaxi_mlops-model", label="Full (Three-Level) Model Name"
)
...
param = {"num_leaves": 40, "objective": "regression", "metric": "rmse"}
num_rounds = 100
