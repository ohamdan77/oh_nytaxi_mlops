...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``oh_nytaxi_mlops/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in oh_nytaxi_mlops/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in oh_nytaxi_mlops/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-oh_nytaxi_mlops-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.oh_nytaxi_mlops.oh_nytaxi_mlops-model", "Full (Three-Level) Model Name")
